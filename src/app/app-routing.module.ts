...
const routes: Routes = [
  ...
  { path: 'set-body-data-class', loadChildren: './pages/set-body-data-class/add-new-data-class.module#AddNewDataClassPageModule' },
  ...
  { path: 'data-blood', loadChildren: './pages/data-blood/data-blood.module#DatabarchartPageModule' },
